# forklength_stats
# visualize and create statistical comparisons for size distributions of whole fish communities and common fish families (centrarchidae, Poeciliidae, Lacustreidae)
