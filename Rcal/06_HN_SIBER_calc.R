# HN_SIBER_calc
# Goal: Estimate isotopic niche area using a HN ellipse, niche height using Food Chain Length, a theoretical niche volume using width * height, and a supplemental table with other metrics such as nearest neighbor distance. report metrics for guild, fish sizes, invertebrate trophic groups, and common taxa in a grid.
